    ...
    <div class="container px-4 py-6 mx-auto">
        <div class="p-6 bg-white rounded-lg shadow-md">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-xl font-semibold text-gray-900">Daftar Tindakan</h3>
            ...
            @if ($actions->isEmpty())
                <p class="text-gray-600">Tidak ada tindakan tersedia.</p>
            @else
                        ...
                        <tbody>
                            @foreach ($actions as $action)
                                <tr>
                                    ...
                                    <td class="px-4 py-2">Rp {{ number_format($action->price, 0, ',', '.') }}</td>
                                    <td class="px-4 py-2">
